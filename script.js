...
const projectsData = [
    ...
    },
    {
        ...
        tech: ["HTML", "CSS", "JavaScript", "Particle.js"],
        features: [
...
// Show the form directly (you can adjust this based on your preference)
projectCreationForm.style.display = 'none'; // Initially hidden
...
contactForm.addEventListener('submit', (e) => {
    ...
    if (!isValid) {
        e.preventDefault(); // This prevents submission to Formspree
        return; // Exit the function
    }

    // If validation PASSES, the form will submit to Formspree normally
    // We'll show a temporary success message until the redirect happens
    formSuccess.textContent = 'Sending your message...';
});
